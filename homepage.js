    ...
    async function topsearch() {
        let response = await fetch(
            `https://newsapi.org/v2/everything?q=t20&apiKey=e0f50a912c704931a073a03da9d3fe0e`
        );
    ...
    async function heading() {
        ...
        let response = await fetch(
            `https://newsapi.org/v2/everything?q=cricket&apiKey=e0f50a912c704931a073a03da9d3fe0e`
        );
        let data = await response.json();
  ...
  function test1(){
        localStorage.setItem("find", JSON.stringify("T20 WORLD CUP"));
        window.location.href = "search.html";
  }
  function test2(){
        localStorage.setItem("find", JSON.stringify("WBBL 2021"));
        window.location.href = "search.html";
  }
  function test3(){
        localStorage.setItem("find", JSON.stringify("SMA TROPHY"));
        window.location.href = "search.html";
  }
  function test4(){
        localStorage.setItem("find", JSON.stringify("MARSH CUP"));
        window.location.href = "search.html";
  }
  function test5(){
        localStorage.setItem("find", JSON.stringify("WOMEN CHAMPIONSHIP"));
        window.location.href = "search.html";
  }
  function test6(){
        localStorage.setItem("find", JSON.stringify("WORLD TEST CHAMPIONSHIP"));
        window.location.href = "search.html";
  }
